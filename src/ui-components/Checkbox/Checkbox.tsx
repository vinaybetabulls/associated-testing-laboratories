import { Checkbox as CheckoboxUI, CheckboxProps, FormControlLabel, FormControlLabelProps } from '@material-ui/core'
...
const Checkbox = (props: Props) => {
  return !!useContext(FormikContext) ? <FormikCheckCircle {...props} /> : <CheckCircle {...props} />
}

const FormikCheckCircle = (props: Props) => {
  const [field, meta] = useField({ name: props.name, type: 'radio', value: props.value })
