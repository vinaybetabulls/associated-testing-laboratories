...
const TextFieldWrappper = (props: Props) => {
  return !!useContext(FormikContext) ? <FormikTextField {...props} /> : <TextField {...props} />
}
const FormikTextField = (props: Props) => {
  ...
  return <TextField setValue={helpers.setValue} {...field} {...props} {...validation} errorMessage={errorMessage} />
}
const TextField = (props: Props) => {
  ...
  return (
    <div className={clsx(classes.textFieldWrapper, fullWidth && classes.fullWidth)}>
      <div className={classes.textContainer}>
        ...
        {errorMessage && !hideError && <span className={classes.errorMessage}>{errorMessage}</span>}
      </div>
    </div>
  )
}
